...
# 	import data 	#
#########################
#LOAD DATA LOCAL INFILE '~/Desktop/knowmin/KnowMin-MIK/categories.csv' IGNORE INTO TABLE mk_categories FIELDS TERMINATED BY ',' OPTIONALLY ENCLOSED BY '\'' LINES TERMINATED BY '\n';
