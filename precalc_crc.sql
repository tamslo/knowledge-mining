Delete from precalc_crc_md5;


Drop PROCEDURE IF EXISTS precalc_crc;

Delimiter $$

CREATE PROCEDURE precalc_crc() 
BLOCK1: BEGIN 
	...
	foreach_category_loop:LOOP 
		...
		INSERT INTO precalc_crc_md5 VALUES(c_category_md5, total_subjects_of_category); 
