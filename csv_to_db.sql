...
LOAD DATA LOCAL INFILE categories_csv_file_path INTO TABLE categories_original FIELDS TERMINATED BY ',' OPTIONALLY ENCLOSED BY '\'' LINES TERMINATED BY '\n';
LOAD DATA LOCAL INFILE statements_csv_file_path INTO TABLE statements_original FIELDS TERMINATED BY ',' OPTIONALLY ENCLOSED BY '\'' LINES TERMINATED BY '\n';
