...
#LOAD DATA LOCAL INFILE '~/Desktop/knowmin/KnowMin-MIK/categories.csv' INTO TABLE categories FIELDS TERMINATED BY ',' OPTIONALLY ENCLOSED BY '"' ESCAPED BY '"' LINES TERMINATED BY '\n';
#LOAD DATA LOCAL INFILE '~/Desktop/knowmin/KnowMin-MIK/statements.csv' INTO TABLE statements FIELDS TERMINATED BY ',' OPTIONALLY ENCLOSED BY '"' ESCAPED BY '"' LINES TERMINATED BY '\n';
